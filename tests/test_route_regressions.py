...
The AGENTMEMORY_SECRET env var is NOT set so all auth checks pass through.
"""
import sys
import os
import json
...
def flask_app(tmp_path_factory):
    ...
    os.environ["AGENTMEMORY_DB_PATH"] = db_path
...
class TestHealthBlueprint:
    ...
    def test_livez_returns_service_name(self, client):
        resp = client.get("/agentmemory/livez")
        data = resp.get_json()
        assert data["service"] == "agentmemory"
    ...
    def test_audit_returns_200(self, client):
        resp = client.get("/agentmemory/audit")
        assert resp.status_code == 200
        data = resp.get_json()
        assert "entries" in data

    def test_config_flags_returns_200(self, client):
        resp = client.get("/agentmemory/config/flags")
        assert resp.status_code == 200
        data = resp.get_json()
...
class TestObservationsBlueprint:
    def test_agent_observe_valid_payload(self, client):
        ...
        resp = _post_json(client, "/agentmemory/agent/observe", payload)
    ...
    def test_folders_list_returns_200(self, client):
        ...
        _post_json(client, "/agentmemory/agent/observe", {
    ...
    def test_folder_observations_returns_200(self, client):
        ...
        resp = client.get("/agentmemory/folder/observations?folderPath=home/user/proj-obs-test&agentId=kiro")
        assert resp.status_code == 200
        data = resp.get_json()
    ...
    def test_folder_observations_missing_params_returns_400(self, client):
        ...
        resp = client.get("/agentmemory/folder/observations")
        assert resp.status_code == 400
    ...
    def test_legacy_observe_endpoint_returns_400_or_201(self, client):
        ...
        resp = _post_json(client, "/agentmemory/observe", payload)
...
class TestMemoriesBlueprint:
    def test_remember_valid_payload(self, client):
        ...
        resp = _post_json(client, "/agentmemory/remember", payload)
        assert resp.status_code == 201
        data = resp.get_json()
        assert "memory" in data

    def test_agent_remember_valid_payload(self, client):
        ...
        resp = _post_json(client, "/agentmemory/agent/remember", payload)
        assert resp.status_code == 201

    def test_agent_remember_missing_content_returns_400(self, client):
        """POST /agent/remember without content returns 400."""
        resp = _post_json(client, "/agentmemory/agent/remember", {"agentId": "kiro"})
        assert resp.status_code == 400
    ...
    def test_memories_list_latest_only(self, client):
        ...
        resp = client.get("/agentmemory/memories?latest=true")
        assert resp.status_code == 200
        data = resp.get_json()
    ...
    def test_forget_memory_by_id(self, client):
        ...
        create_resp = _post_json(client, "/agentmemory/remember", {
            "content": "This memory will be forgotten",
            "type": "fact",
        })
        mem_id = create_resp.get_json()["memory"]["id"]
        # Forget it
        resp = _post_json(client, "/agentmemory/forget", {"memoryId": mem_id})
        assert resp.status_code == 200
        data = resp.get_json()
    ...
    def test_forget_folder_pair(self, client):
        ...
        resp = _post_json(client, "/agentmemory/forget", {
            "folderPath": fp,
            "agentId": "kiro",
        })
        assert resp.status_code == 200
...
class TestSearchBlueprint:
    def test_search_with_query_returns_200(self, client):
        ...
        resp = _post_json(client, "/agentmemory/search", {"query": "authentication"})
        assert resp.status_code == 200

    def test_search_missing_query_returns_400(self, client):
        """POST /search without query returns 400."""
        resp = _post_json(client, "/agentmemory/search", {})
        assert resp.status_code == 400
    ...
    def test_timeline_returns_200(self, client):
        ...
        resp = _post_json(client, "/agentmemory/timeline", {})
        assert resp.status_code == 200
        data = resp.get_json()
        assert "observations" in data
...
class TestGraphBlueprint:
    ...
    def test_graph_stats_returns_200(self, client):
        ...
        resp = client.get("/agentmemory/graph/stats")
        assert resp.status_code == 200
        data = resp.get_json()
        assert "nodes" in data
        assert "edges" in data
    ...
    def test_graph_query_returns_200(self, client):
        ...
        resp = _post_json(client, "/agentmemory/graph/query", {})
        assert resp.status_code == 200

    def test_graph_build_returns_200(self, client):
        """POST /graph/build returns 200."""
        resp = _post_json(client, "/agentmemory/graph/build", {})
        assert resp.status_code == 200
...
class TestMcpBlueprint:
    ...
    def test_mcp_tool_call_agent_observe(self, client):
        ...
        resp = _post_json(client, "/agentmemory/mcp/tools", payload)
        assert resp.status_code == 200
        data = resp.get_json()
        assert "content" in data

    def test_mcp_tool_call_memory_recall(self, client):
        """POST /mcp/tools memory_recall returns 200."""
        resp = _post_json(client, "/agentmemory/mcp/tools", {
            "name": "memory_recall",
            "arguments": {"query": "authentication"},
        })
        assert resp.status_code == 200

    def test_mcp_tool_call_memory_diagnose(self, client):
        """POST /mcp/tools memory_diagnose returns folderCount etc."""
        resp = _post_json(client, "/agentmemory/mcp/tools", {
    ...
    def test_mcp_tool_call_memory_folders(self, client):
        """POST /mcp/tools memory_folders returns list."""
        resp = _post_json(client, "/agentmemory/mcp/tools", {
            "name": "memory_folders",
            "arguments": {},
        })
    ...
    def test_mcp_tool_call_memory_timeline(self, client):
        """POST /mcp/tools memory_timeline returns list."""
        resp = _post_json(client, "/agentmemory/mcp/tools", {
    ...
    def test_mcp_tool_missing_name_returns_400(self, client):
        ...
        resp = _post_json(client, "/agentmemory/mcp/tools", {"arguments": {}})
        assert resp.status_code == 400
...
class TestMigrationBlueprint:
    def test_migrate_dry_run_returns_200(self, client):
        ...
        resp = _post_json(client, "/agentmemory/migrate", {"dry_run": True})
        assert resp.status_code == 200
        data = resp.get_json()
    ...
    def test_migrate_without_body_defaults_to_no_dry_run(self, client):
        ...
        resp = _post_json(client, "/agentmemory/migrate", {})
        assert resp.status_code == 200
...
class TestBlueprintRegistration:
    def test_all_expected_endpoints_registered(self, flask_app):
        ...
        # observations.py
        assert "/agentmemory/agent/observe" in registered_rules
        assert "/agentmemory/folders" in registered_rules
        assert "/agentmemory/folder/observations" in registered_rules

        # memories.py
        assert "/agentmemory/remember" in registered_rules
        assert "/agentmemory/memories" in registered_rules
        assert "/agentmemory/forget" in registered_rules

        # search.py
        assert "/agentmemory/search" in registered_rules
        assert "/agentmemory/timeline" in registered_rules

        # graph.py
        assert "/agentmemory/graph" in registered_rules
        assert "/agentmemory/graph/stats" in registered_rules
        assert "/agentmemory/graph/query" in registered_rules

        # health.py
        assert "/agentmemory/livez" in registered_rules
        assert "/agentmemory/health" in registered_rules
        assert "/agentmemory/audit" in registered_rules
        assert "/agentmemory/config/flags" in registered_rules

        # mcp.py
        assert "/agentmemory/mcp/tools" in registered_rules

        # migration.py
        assert "/agentmemory/migrate" in registered_rules
    ...
    def test_auth_returns_401_when_secret_set(self, client, flask_app):
        """When AGENTMEMORY_SECRET is configured, missing token returns 401 on protected routes.

        /agentmemory/audit requires auth; /agentmemory/livez and /agentmemory/health are open.
        """
        os.environ["AGENTMEMORY_SECRET"] = "test-secret-token"
        try:
            resp = client.get("/agentmemory/audit")
    ...
    def test_livez_always_open_regardless_of_secret(self, client):
        ...
        os.environ["AGENTMEMORY_SECRET"] = "some-secret"
        try:
            resp = client.get("/agentmemory/livez")
            assert resp.status_code == 200
        finally:
